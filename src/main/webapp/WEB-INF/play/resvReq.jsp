...
//              buyer_postcode: $("#oif_ordaddr1").val(),
        ...
        IMP.request_pay({
           ...
           buyer_name: $("#resv_name").val(),
           buyer_tel: $("#resv_tel").val(),
           m_redirect_url: 'http://www.farmproject.kro.kr/resv.do?resv_num='+oif_id+'&'+queryString,
           }, function (rsp) {
              console.log(rsp);
        });
   }
...
<!--                   <small>&gt; 다른 내용이 있을경우 유저 페이지에서 수정 부탁드립니다.</small><br> -->
               ...
               <div class="resvDiv">
                  ...
                  <span class="user-info">
	                  <span><!-- mCnt -->
	                  	  <span>성인인원</span><span><input type="number" class="mCnt" id="resv_headcount" name="resv_headcount" min="0" max="9" value="0" required></span>
	                  </span><span>
		                  <span>청소년인원</span><span><input type="number" class="mCnt" id="resv_youthheadcount" name="resv_youthheadcount" min="0" max="9" value="0" required></span>
	                  </span>
                  </span>
                  <span class="user-info">
