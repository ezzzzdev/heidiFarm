	...
	<nav id="stNav" class="navbar navbar-expand-sm">
		...
		<ul class="navbar-nav nav-topCenter">
			<li class="nav-item nav-firstItem">
				<a class="nav-link tmenu" href="/introduce.jsp" id="navbardrop">소개글</a>
			</li>
			<li class="nav-item">
				<a class="nav-link tmenu" href="/playMain.do" id="navbardrop">체험소개</a>
			</li>
			<li class="nav-item">
				<a class="nav-link tmenu" href="/resvMain.do">체험예약</a>
			</li>
			<li class="nav-item">
				<a class="nav-link tmenu" href="/productList.do">상품</a>
			</li>
			<li class="nav-item">
				<a class="nav-link tmenu" href="/getNoticeList.do" id="navbardrop"> 커뮤니티 </a>
			</li>
		</ul>
			...
			<c:when test='${user_id ne NULL}'>
				...
				<c:otherwise>
					...
					<c:choose>
						...
						<li class="nav-item">
							<a class="nav-link tmenu">${user_name}님</a>
						</li>
						</c:when>
						<c:otherwise>
								<li class="nav-item">
						<c:choose>
							<c:when test='${user_id eq "farmadmin" }'>
									<a class="nav-link tmenu">관리자님</a>
							</c:when>
							<c:otherwise>
									<a class="nav-link tmenu">${user_id}님</a>
							</c:otherwise>
						</c:choose>
								</li>
						</c:otherwise>
...
<div id="box">
<div class="row">
		<div id="content1" class="col"><a id="content1" class="nav-link item-bottom"href="playMain.do">체험소개</a></div>
		<div id="content2" class="col"><a id="content2" class="nav-link item-bottom" href="/playSchedule.do?clickCount=0">체험일정</a></div>
		<div id="content3" class="col"><a id="content3" class="nav-link item-bottom" href="playQNA.do">FAQ</a></div>
	</div>
</div>
