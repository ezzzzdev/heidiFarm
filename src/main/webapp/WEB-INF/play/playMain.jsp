...
<div class="container">
	...
	<!-- 체험 내용 소개부분 -->
	<div class="content">
		<h4 class="mini-category category-bottom"><svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" fill="currentColor" class="bi bi-filter-square" viewBox="0 0 16 16">
...
<h4 class="mini-category"><svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" fill="currentColor" class="bi bi-exclamation-circle" viewBox="0 0 16 16">
