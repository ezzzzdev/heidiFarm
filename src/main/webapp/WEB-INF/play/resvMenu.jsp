...
<style>
	...
	.nav-link { font-family: 'SUITE-Regular';} 
</style>

<%
String userId = session.getAttribute("user_id") != null ? session.getAttribute("user_id").toString() : "";
String userName = session.getAttribute("user_name") != null ? session.getAttribute("user_name").toString() : "";
%>
	...
	<nav id="stNav" class="navbar navbar-expand-sm">
		...
		<ul class="navbar-nav nav-topCenter">
			<li class="nav-item nav-firstItem">
				<a class="nav-link" href="/introduce.jsp" id="navbardrop">소개글</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/playMain.do" id="navbardrop">체험소개</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/resvMain.do">체험예약</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/productList.do">상품</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/getNoticeList.do" id="navbardrop"> 커뮤니티 </a>
			</li>
		</ul>
...
<div id="box">
<div class="row">
		<div id="content1" class="col"><a id="content1" class="nav-link item-bottom " href="resvMain.do">체험예약</a></div>
		<div id="content2" class="col"><a id="content2" class="nav-link item-bottom " href="resvCheck.do">예약내역</a></div>		
	</div>
</div>
