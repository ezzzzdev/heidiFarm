...
//	공지사항
	...
	public String noticeList(PagingVO pv, NoticeVO vo, Model model)  {
		String cntPerPage = "10";
		if (vo.getSearchCondition() == null)
		...
		pv = new PagingVO(total, 1, Integer.parseInt(cntPerPage));
		model.addAttribute("paging", pv);
		vo.setStart(pv.getStart());
		vo.setListcnt(Integer.parseInt(cntPerPage));
...
//	Qna 목록
	...
	public String adminQnaList(PagingVO pv, QNAVO vo, Model model) {
		String cntPerPage = "10";
		if (vo.getSearchCondition() == null)
			vo.setSearchCondition("QNA_TITLE");
		else
